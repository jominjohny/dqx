...
| `is_not_equal_to`                  | Checks whether the values in the input column are not equal to the provided value.                                                                                                                                                                                                                                                                                                                                                | `column`: column to check (can be a string column name or a column expression); `value`: comparison value as number, string, date, timestamp, column name, or SQL expression                                                                                                                                                                                                                                                                                                                                                                         |
| `is_equal_to`                      | Checks whether the values in the input column are equal to the provided value.                                                                                                                                                                                                                                                                                                                                                    | `column`: column to check (can be a string column name or a column expression); `value`: comparison value as number, string, date, timestamp, column name, or SQL expression                                                                                                                                                                                                                                                                                                                                                                         |
...
ref_dfs = {"ref_view": ref_df}  # mapping of reference data name to DataFrame, multiple references can be provided
...
```
reference_tables:
  ref_view:                            # <- name of the reference data
